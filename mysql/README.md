...
- Refer to the [link](./FAQ.md)) to solve the errors.
...
1. Execute the expriments with buffer pool size of 10%, 30% and 50%. For the report submission, please refer to the [link](./submission-guide.md). <br/>
